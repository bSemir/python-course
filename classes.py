...
class MyClass:
    ...
    def __init__(self, my_int: int):  # __init__ je konstruktor koji prima self i ostalo po potrebi
        self.i = my_int
...
class Dog:
    ...
    def __init__(self, name):  # we can pass in anything, but with name:str it has to be string
...
class MappingSubclass(Mapping):
    def update(self, keys, values):
        ...
        # zip is built in method that zips two lists together to key value pairs
...
m.items_list
# output -> [('one', 'these'), ('two', 'are'), ('three', 'values')]
